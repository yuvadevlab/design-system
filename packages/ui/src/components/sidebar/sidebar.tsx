...
/**
 * Hook to access the parent Sidebar context state and controls.
 */
function useSidebar() {
...
export type SidebarProviderProps = React.ComponentProps<"div"> & {
  /** Initial open state in uncontrolled mode (default: true) */
  defaultOpen?: boolean;
...
/**
 * Top-level provider orchestrating sidebar state, responsive breakpoints, and keyboard shortcuts (Cmd+B / Ctrl+B).
 *
 * @example
 * ```tsx
 * <SidebarProvider>
...
export type SidebarProps = React.ComponentProps<"div"> & {
  /** Side where the sidebar is positioned (default: "left") */
  side?: "left" | "right";
  /** Sidebar variant style (default: "sidebar") */
  variant?: "sidebar" | "floating" | "inset";
  /** Collapse behavior when toggled (default: "offcanvas") */
  collapsible?: "offcanvas" | "icon" | "none";
};

/**
 * Main collapsible navigation sidebar supporting floating, inset, desktop, and mobile sheet views.
 */
    ...
    return (
      ...
      >
        ...
        >
          <div
            data-sidebar="sidebar"
            className="flex flex-col bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow size-full"
          >
            {children}
          </div>
        </div>
...
/**
 * Button trigger toggling sidebar collapsed/expanded state.
 */
...
/**
 * Hoverable/draggable rail divider on the edge of the sidebar for quick toggling.
 */
...
/**
 * Main application container when paired with an inset or standard sidebar.
 */
...
/**
 * Styled text input tailored for use inside a sidebar header or filter bar.
 */
...
>(({ className, ...props }, ref) => {
  return (
    <Input
      ref={ref}
      data-sidebar="input"
      className={cn("dl-sidebar-input", className)}
      {...props}
    />
  );
});
...
/**
 * Header section at the top of a sidebar.
 */
...
/**
 * Footer section pinned to the bottom of a sidebar.
 */
...
/**
 * Divider separating sidebar sections.
 */
...
/**
 * Scrollable middle container holding sidebar navigation groups.
 */
...
/**
 * Section grouping related sidebar menu items.
 */
...
/**
 * Text heading or label for a `SidebarGroup`.
 */
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/70 outline-none ring-sidebar-ring transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4",
...
/**
 * Secondary action button placed beside a `SidebarGroupLabel` (e.g. "+" to add items).
 */
...
/**
 * Content container rendered inside a `SidebarGroup`.
 */
...
/**
 * Vertical list (`<ul>`) holding sidebar menu items.
 */
...
/**
 * List item (`<li>`) wrapper for a sidebar navigation button or link.
 */
...
/**
 * Interactive navigation button inside a sidebar menu item, with automatic tooltip in collapsed icon mode.
 */
...
/**
 * Secondary action button placed beside a sidebar menu button (e.g. "..." more options menu).
 */
...
/**
 * Numeric or label badge placed on the right side of a sidebar menu button.
 */
...
/**
 * Loading skeleton placeholder simulating a sidebar menu item.
 */
...
/**
 * Nested sub-list container for hierarchical sidebar navigation.
 */
...
/**
 * Nested item wrapper inside a `SidebarMenuSub`.
 */
...
/**
 * Navigation button/link inside a nested `SidebarMenuSub` tree.
 */

    ...
    <Popover open={open} onOpenChange={handleOpenChange}>
      <PopoverTrigger asChild>
        <Button
          ...
          className={cn(
            "bg-background border-input hover:bg-accent/50 h-9 w-full justify-between px-3 text-left font-normal",
      ...
      <PopoverContent
        align="start"
        className="border-border bg-popover w-(--radix-popover-trigger-width) min-w-55 border p-0 shadow-lg"
        onKeyDown={handleKeyDown}
      >
